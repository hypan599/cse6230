...
void accelerate(Accel accel, Vector X, Vector U, int control_update, int update_inter_pair) //add the coefficient of period update_inter_pair
{
    int Npairs;
    ix_pair *pairs;
    if (accel->use_ix)
